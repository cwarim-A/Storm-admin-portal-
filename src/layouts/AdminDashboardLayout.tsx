...
import LogoutModal from "@/admin/dashboard/components/LogoutModal";
	...
	return (
		<ThemeProvider>
			<div className="flex w-full min-h-screen bg-gray-50/20 dark:bg-[#0b0b0b] text-black dark:text-white">
				...
				<aside
					className={`w-72 bg-white dark:bg-neutral-900 pt-5 px-4 pb-4 h-screen border-r dark:border-neutral-800 shadow-2xs fixed left-0 top-0 z-50 transition-transform ${
