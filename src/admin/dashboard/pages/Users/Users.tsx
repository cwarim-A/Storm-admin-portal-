...
import { SuspendUserModal, WarnUserModal, BanUserModal } from "./UserModals";
										...
										<DropdownMenu>
											...
											<DropdownMenuContent align="end">
												...
												<DropdownMenuItem asChild>
													<Link to={_router.admin.dashboard.userDetails.replace(":id", row.id)} className="cursor-pointer">
														<IconWrapper className="text-lg">
															<EyeIcon />
														</IconWrapper>
