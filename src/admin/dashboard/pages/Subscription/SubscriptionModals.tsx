			...
			<DialogContent showCloseButton={false} className="p-0 overflow-hidden w-full pb-4">
				...
				<div className="p-4">
					<div className="flex flex-col items-center text-center gap-y-6">
						<IconWrapper className="text-5xl text-(--primary-clr)">
							<SquigglyCheckIcon />
						</IconWrapper>
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4 w-full sm:w-auto">
							<button
								type="button"
								className={`${twMerge(smBtnStyle, "bg-transparent border-2 border-(--primary-clr) dark:text-gray-300 gap-2 p-2 w-full sm:w-auto")}`}>
							...
							<button
								...
								className={`${twMerge(smBtnStyle, "p-2 w-full sm:w-auto border-2 border-(--primary-clr)")}`}>
