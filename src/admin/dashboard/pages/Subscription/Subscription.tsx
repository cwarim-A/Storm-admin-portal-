			...
			<CustomCard className="bg-white w-full dark:bg-neutral-900 rounded-lg p-4 border">
				<div className="flex items-center gap-3 mb-4">
					...
					<div className="ml-auto flex items-center gap-3">
						<Link to={_router.admin.dashboard.addSubscriber} className={`${preTableButtonStyle} bg-(--primary-clr)`}>
							<IconWrapper>
								<Plus size={16} />
							</IconWrapper>
													...
													<DropdownMenu>
														...
														<DropdownMenuContent align="end">
															<DropdownMenuItem asChild>
																<Link to={_router.admin.dashboard.subscriptionHistory} className="flex items-center gap-2 cursor-pointer">
																	<IconWrapper>
																		<EyeIcon />
																	</IconWrapper>
