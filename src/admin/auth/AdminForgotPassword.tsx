			...
			<form action="">
				{stepperLevel === 1 ? (
					<div className="flex flex-col gap-y-6">
						<div>
							...
							<div className="flex justify-end mt-2">
								<p className="text-sm">
									Remember Password?{" "}
									<Link to={_router.admin.auth.login} className="underline">
										Login
									</Link>
								</p>
							</div>
						...
						<div className="mt-10">
							<Button
								className="bg-(--primary-clr) active-scale rounded-md text-sm hover:bg-(--primary-clr)/90 text-black h-12 w-full"
								type="button"
					...
					<div className="flex flex-col gap-y-6">
						...
						<div className="mt-10">
							<Button
								className="bg-(--primary-clr) rounded-md active-scale hover:bg-(--primary-clr)/90 text-black text-sm h-12 w-full"
								type="button"
